    ...
    methods: {
      setGraphData() {
        ...
        __graph_json_data.nodes.forEach(thisNode => {
          ...
          // 为节点N12、N13、N14设置属性expandHolderPosition，使其在没有子节点的情况下也能显示【展开/收缩】按钮，当点击展开时动态加载子节点数据
          if (thisNode.id === 'N12' || thisNode.id === 'N13' || thisNode.id === 'N14') {
